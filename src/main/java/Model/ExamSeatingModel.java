...
public class ExamSeatingModel {
    ...
    public List<SeatMapModel> assignRooms(List<StudentModel> students, String sortCriteria, int maxStudentsPerRoom) {
        ...
        for (StudentModel student : students) {
            String key = switch (sortCriteria) {
                case "Course Code" ->
                        student.getCourseCode() + "_" + student.getExamDateTime() + "_" + student.getSection();
                case "Exam Date/Time" ->
                        student.getExamDateTime() + "_" + student.getCourseCode() + "_" + student.getSection();
                case "Section" ->
                        student.getSection() + "_" + student.getCourseCode() + "_" + student.getExamDateTime();
                default -> student.getCourseCode() + "_" + student.getExamDateTime() + "_" + student.getSection();
            };

            groupedStudents.computeIfAbsent(key, e -> new ArrayList<>()).add(student);
        }
